...
<section id="Tools">
  ...
  <img src="../UMUZ/css/notes.png" alt="Imagen">
    <div class="card-content">
      <h3>Notes</h3>
      <button class="btn-enter" data-link="../UMUZ/notes/index.php">Enter</button>
    </div>
  </div>
  ...
  <img src="../UMUZ/css/chart.png" alt="Imagen">
    <div class="card-content">
      <h3>Charts </h3>
      <button class="btn-enter" data-link="../UMUZ/chart/index.php">Enter</button>
    </div>
  </div>
  ...
  <img src="../UMUZ/css/time.png" alt="Imagen">
    <div class="card-content">
      <h3>Weather</h3>
      <button class="btn-enter" data-link="../UMUZ/time/index.php">Enter</button>
    </div>
  </div>
  ...
  <img src="../UMUZ/css/calc.png" alt="Imagen">
    <div class="card-content">
      <h3>Calculator</h3>
      <button class="btn-enter" data-link="../UMUZ/calc/index.php">Enter</button>
    </div>
  </div>
  ...
  <img src="../UMUZ/css/board.png" alt="Imagen">
    <div class="card-content">
      <h3>Whiteboard</h3>
      <button class="btn-enter" data-link="../UMUZ/board/index.php">Enter</button>
    </div>
  </div>
  ...
  <img src="../UMUZ/css/cv.png" alt="Imagen">
    <div class="card-content">
      <h3>Curriculum</h3>
      <button class="btn-enter" data-link="../UMUZ/cv/index.php">Enter</button>
    </div>
  </div>
  ...
  <img src="../UMUZ/css/docs.png" alt="Imagen">
    <div class="card-content">
      <h3>Bookkeeper</h3>
      <button class="btn-enter" data-link="../UMUZ/docs/autonomo.php">Enter</button>
    </div>
  </div>
  ...
  <img src="../UMUZ/css/code.png" alt="Imagen">
    <div class="card-content">
      <h3>Exchange</h3>
      <button class="btn-enter" data-link="../UMUZ/code/index.php">Enter</button>
    </div>
  </div>
<!--
  <div id="card" class="card">
  <img src="../UMUZ/css/bak.png" alt="Imagen">
    <div class="card-content">
      <h3>Code/h3>
...
-->
  ...
  <script src="../UMUZ/UMUZ/js/index.js"></script>  
