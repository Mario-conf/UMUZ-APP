...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/../UMUZ/css/all.min.css">
  <link rel="stylesheet" href="../UMUZ/css/board.css">
...
<body>
  <header>
    <nav>
      ...
      <ul class="nav-links">
       ...
       <li><button class="exp-button" onclick="window.location.href='../UMUZ/web.php'" class="btn">Go to Web Panel</button></li>
  ...
  <script src="../UMUZ/UMUZ/js/board.js"></script>
  <footer>
  <style>
      footer a {
        color: #dddddd;
